<template>
  <div class="game-area">
    <h1 class="title">Poğaça <span>Nerede</span> <strike>?</strike></h1>
...
/******Açık kartların animasyonları için gerekli olan class tanımları */
...
/******Kapalı kartın animasyonları için gerekli olan class tanımları */

.rotate-enter {
}
.rotate-enter-active {
  animation: rotate-in ease-in 0.5s forwards;
}
.rotate-leave {
}
.rotate-leave-active {
  animation: rotate-out ease-out 0.5s forwards;
}
